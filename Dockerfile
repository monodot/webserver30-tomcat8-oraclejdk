...
RUN /usr/sbin/alternatives --install "/usr/bin/java" java "/usr/lib/jvm/jdk1.8.0_$JAVA_UPDATE_VERSION/bin/java" 1
RUN /usr/sbin/alternatives --set "java" "/usr/lib/jvm/jdk1.8.0_$JAVA_UPDATE_VERSION/bin/java"
RUN /usr/sbin/alternatives --install "/usr/bin/javac" javac "/usr/lib/jvm/jdk1.8.0_$JAVA_UPDATE_VERSION/bin/javac" 1
RUN /usr/sbin/alternatives --set "javac" "/usr/lib/jvm/jdk1.8.0_$JAVA_UPDATE_VERSION/bin/javac"
